var nsOptions =
{
    ...
    transitionType: "none", //"fade", "slide", "zoom", "kenburns 1.2" or "none"
    autoAdvance: false,
    delay: "default",
    transitionSpeed: 700,
    aspectRatio: "2:1",
...
(function($) {
    $('.entry-summary .button-wrapper').wrapAll('<div class="button-wrap"></div>');
})(jQuery);

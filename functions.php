...
function daneh_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'daneh_custom_background_args', array(
...
function daneh_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'daneh_content_width', 640 );
}
...
function daneh_scripts() {
	...
	wp_enqueue_script( 'daneh-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'daneh-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
